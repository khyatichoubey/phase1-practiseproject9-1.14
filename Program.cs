...
class Program
{
    static void Main()
    {
        ...
        // Adding dummy data
        repository.AddStudent(new Student { Name = "Akshay", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "Om", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "Anurag", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "Swati", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "Pratibha", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "Nisha", ClassAndSection = "ClassA" });

        repository.AddStudent(new Student { Name = "Ajay", ClassAndSection = "ClassB" });
        repository.AddStudent(new Student { Name = "Nagendra", ClassAndSection = "ClassB" });
        repository.AddStudent(new Student { Name = "Ankit", ClassAndSection = "ClassB" });
        repository.AddStudent(new Student { Name = "Bilash", ClassAndSection = "ClassB" });
